...
mixin _$TechnicianProfile {
 ...
 bool get isAvailable; String get ratingAvg; List<int> get serviceCategoryIds; List<String> get serviceCategoryNames; int get completedOrdersCount; DateTime? get memberSince; String? get profilePhotoUrl;
...
@override
int get hashCode => Object.hash(runtimeType,id,name,phone,status,isAvailable,ratingAvg,const DeepCollectionEquality().hash(serviceCategoryIds),const DeepCollectionEquality().hash(serviceCategoryNames),completedOrdersCount,memberSince,profilePhotoUrl);

@override
String toString() {
  return 'TechnicianProfile(id: $id, name: $name, phone: $phone, status: $status, isAvailable: $isAvailable, ratingAvg: $ratingAvg, serviceCategoryIds: $serviceCategoryIds, serviceCategoryNames: $serviceCategoryNames, completedOrdersCount: $completedOrdersCount, memberSince: $memberSince, profilePhotoUrl: $profilePhotoUrl)';
}
...
@useResult
$Res call({
 int id, String name, String phone, String status, bool isAvailable, String ratingAvg, List<int> serviceCategoryIds, List<String> serviceCategoryNames, int completedOrdersCount, DateTime? memberSince, String? profilePhotoUrl
});
...
/// Create a copy of TechnicianProfile
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? phone = null,Object? status = null,Object? isAvailable = null,Object? ratingAvg = null,Object? serviceCategoryIds = null,Object? serviceCategoryNames = null,Object? completedOrdersCount = null,Object? memberSince = freezed,Object? profilePhotoUrl = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String name,  String phone,  String status,  bool isAvailable,  String ratingAvg,  List<int> serviceCategoryIds,  List<String> serviceCategoryNames,  int completedOrdersCount,  DateTime? memberSince,  String? profilePhotoUrl)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TechnicianProfile() when $default != null:
return $default(_that.id,_that.name,_that.phone,_that.status,_that.isAvailable,_that.ratingAvg,_that.serviceCategoryIds,_that.serviceCategoryNames,_that.completedOrdersCount,_that.memberSince,_that.profilePhotoUrl);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String name,  String phone,  String status,  bool isAvailable,  String ratingAvg,  List<int> serviceCategoryIds,  List<String> serviceCategoryNames,  int completedOrdersCount,  DateTime? memberSince,  String? profilePhotoUrl)  $default,) {final _that = this;
switch (_that) {
case _TechnicianProfile():
return $default(_that.id,_that.name,_that.phone,_that.status,_that.isAvailable,_that.ratingAvg,_that.serviceCategoryIds,_that.serviceCategoryNames,_that.completedOrdersCount,_that.memberSince,_that.profilePhotoUrl);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String name,  String phone,  String status,  bool isAvailable,  String ratingAvg,  List<int> serviceCategoryIds,  List<String> serviceCategoryNames,  int completedOrdersCount,  DateTime? memberSince,  String? profilePhotoUrl)?  $default,) {final _that = this;
switch (_that) {
case _TechnicianProfile() when $default != null:
return $default(_that.id,_that.name,_that.phone,_that.status,_that.isAvailable,_that.ratingAvg,_that.serviceCategoryIds,_that.serviceCategoryNames,_that.completedOrdersCount,_that.memberSince,_that.profilePhotoUrl);case _:
  return null;
...
class _TechnicianProfile implements TechnicianProfile {
  const _TechnicianProfile({required this.id, required this.name, required this.phone, required this.status, required this.isAvailable, this.ratingAvg = '0.00', final  List<int> serviceCategoryIds = const [], final  List<String> serviceCategoryNames = const [], this.completedOrdersCount = 0, this.memberSince, this.profilePhotoUrl}): _serviceCategoryIds = serviceCategoryIds,_serviceCategoryNames = serviceCategoryNames;
...
@override
int get hashCode => Object.hash(runtimeType,id,name,phone,status,isAvailable,ratingAvg,const DeepCollectionEquality().hash(_serviceCategoryIds),const DeepCollectionEquality().hash(_serviceCategoryNames),completedOrdersCount,memberSince,profilePhotoUrl);
...
/// Create a copy of TechnicianProfile
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? phone = null,Object? status = null,Object? isAvailable = null,Object? ratingAvg = null,Object? serviceCategoryIds = null,Object? serviceCategoryNames = null,Object? completedOrdersCount = null,Object? memberSince = freezed,Object? profilePhotoUrl = freezed,}) {
