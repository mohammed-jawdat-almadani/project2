...
mixin _$NotificationItem {
 ...
 int get id; String get category;// 'orders', 'financial', 'admin'
 String get title; String get body; String? get targetType; int? get targetId; bool get isRead; DateTime? get readAt; DateTime? get createdAt;
...
@override
int get hashCode => Object.hash(runtimeType,id,category,title,body,targetType,targetId,isRead,readAt,createdAt);

@override
String toString() {
  return 'NotificationItem(id: $id, category: $category, title: $title, body: $body, targetType: $targetType, targetId: $targetId, isRead: $isRead, readAt: $readAt, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 int id, String category, String title, String body, String? targetType, int? targetId, bool isRead, DateTime? readAt, DateTime? createdAt
});
...
/// Create a copy of NotificationItem
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? category = null,Object? title = null,Object? body = null,Object? targetType = freezed,Object? targetId = freezed,Object? isRead = null,Object? readAt = freezed,Object? createdAt = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String category,  String title,  String body,  String? targetType,  int? targetId,  bool isRead,  DateTime? readAt,  DateTime? createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NotificationItem() when $default != null:
return $default(_that.id,_that.category,_that.title,_that.body,_that.targetType,_that.targetId,_that.isRead,_that.readAt,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String category,  String title,  String body,  String? targetType,  int? targetId,  bool isRead,  DateTime? readAt,  DateTime? createdAt)  $default,) {final _that = this;
switch (_that) {
case _NotificationItem():
return $default(_that.id,_that.category,_that.title,_that.body,_that.targetType,_that.targetId,_that.isRead,_that.readAt,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String category,  String title,  String body,  String? targetType,  int? targetId,  bool isRead,  DateTime? readAt,  DateTime? createdAt)?  $default,) {final _that = this;
switch (_that) {
case _NotificationItem() when $default != null:
return $default(_that.id,_that.category,_that.title,_that.body,_that.targetType,_that.targetId,_that.isRead,_that.readAt,_that.createdAt);case _:
  return null;
...
class _NotificationItem implements NotificationItem {
  const _NotificationItem({required this.id, required this.category, required this.title, required this.body, this.targetType, this.targetId, required this.isRead, this.readAt, this.createdAt});
  

@override final  int id;
@override final  String category;
// 'orders', 'financial', 'admin'
...
/// Create a copy of NotificationItem
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? category = null,Object? title = null,Object? body = null,Object? targetType = freezed,Object? targetId = freezed,Object? isRead = null,Object? readAt = freezed,Object? createdAt = freezed,}) {
